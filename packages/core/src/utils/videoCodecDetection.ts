...
export function detectSupportedCodecs(): CodecSupport {
    ...
    const support: CodecSupport = {
        ...
        hevcMain:
            canPlayType('video/mp4; codecs="hev1.1.6.L123.B0"') || // Main profile, level 4.1 (1080p)
            canPlayType('video/mp4; codecs="hvc1.1.6.L123.B0"'), // Main profile (alternative)
        hevcMain10:
            canPlayType('video/mp4; codecs="hev1.2.4.L123.B0"') || // Main 10 profile, level 4.1
            canPlayType('video/mp4; codecs="hvc1.2.4.L123.B0"'), // Main 10 profile (alternative)
        vp9:
...
export function getSupportedVideoCodecs(): string {
    ...
    if (support.hevcMain || support.hevcMain10) codecs.push('hevc');
